export function Header() {
    return(
        <header className="w-9/10">
            ...
            <h3 className="my-3 text-lg text-white">Inspiration for home cooks</h3>
            <div className="bg-[var(--secondary-color)] max-w-lg rounded-lg mb-4">
                ...
                <ul className="pl-4 pb-4">
                    <li className="text-base poppins-regular text-white leading-relaxed">💡 Get ideas for your next meal!</li>
