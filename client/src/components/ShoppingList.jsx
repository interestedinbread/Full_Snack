...
export function ShoppingList(props) {
    const { shoppingListItems, handleMultiDeleteFromList, handleMultiAddToList, setRefetchTrigger } = props
    ...
    return (
        <>
            ...
            {backedUpItems.length > 0 && <div className="bg-[var(--secondary-color)] w-9/10 rounded-lg">
