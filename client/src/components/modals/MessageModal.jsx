...
export function MessageModal (props) {
    ...
    return ReactDom.createPortal(
        <div className="fixed inset-0 flex mt-55 justify-center z-30 p-4
                      md:left-1/2 md:transform md:-translate-x-1/2 md:w-96 md:h-[800px] md:rounded-[2.5rem] md:overflow-hidden md:mt-20
            ...
            <motion.div className="w-2/3 bg-[var(--secondary-color)] rounded-md p-4 h-max z-50
                                 ...
                                 lg:w-60 lg:left-1/2 lg:transform lg:-translate-x-1/2 lg:top-55 lg:rounded-lg lg:fixed lg:inset-auto"
            key="message-portal"
